        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UseAvailabilities = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    UseUnavailabilities = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    MaxWeekDaysLodgerCount = table.Column<int>(type: "int", nullable: false),
                    MaxWeekendDaysLodgerCount = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeamMedia", x => new { x.TeamId, x.MediaId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TeamMedia_medias_MediaId",
                        column: x => x.MediaId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Availabilities_Calendars_CalendarId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    CalendarId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    LodgerCount = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reservations_Calendars_CalendarId",
                        column: x => x.CalendarId,
                        principalTable: "Calendars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReservationMedia", x => new { x.ReservationId, x.MediaId });
                    table.ForeignKey(
                        name: "FK_ReservationMedia_Reservations_ReservationId",
                        column: x => x.ReservationId,
                        principalTable: "Reservations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReservationMedia_medias_MediaId",
                        column: x => x.MediaId,
                        principalTable: "medias",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Availabilities_CalendarId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReservationMedia_MediaId",
                table: "ReservationMedia",
                column: "MediaId");

            migrationBuilder.CreateIndex(
                name: "IX_Reservations_CalendarId",
                table: "Reservations",
                column: "CalendarId");
